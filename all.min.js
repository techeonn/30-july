  ...
  g[h] = {
    ...
    settings: {
      ...
      loadStarted: function () {
        var b = this.settings.createPlayer, a = j(b.durationClass, this.wrapper), c = Math.floor(this.duration / 60),
      ...
      memoryLeaking: false, listeners: [], addListener: function (b, a, c) {
        ...
        return function (b) {
          var a = window, c = false, d = true, e = a.document, i = e.documentElement,
            ...
            k = e.addEventListener ? "removeEventListener" : "detachEvent", n = e.addEventListener ? "" : "on",
            m = function (l) {
